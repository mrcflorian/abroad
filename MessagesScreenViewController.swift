...
class MessagesScreenViewController: JSQMessagesViewController {

    var user: FAuthData?

    var messages = [NLFNucleusMessage]()
    ...
    func setupFirebase() {
        ...
        messagesRef.queryLimitedToNumberOfChildren(25).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) in
            ...
            let message = NLFNucleusMessage(text: text, sender: sender, imageUrl: imageUrl)
    ...
    func tempSendMessage(text: String!, sender: String!) {
        let message = NLFNucleusMessage(text: text, sender: sender, imageUrl: senderImageUrl)
